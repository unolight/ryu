...
OFPAT_ENCRYPT = 12      # Encrypt packet
OFPAT_DECRYPT = 13      # Decrypt packet
...
OFP_ACTION_ENCRYPT_PACK_STR = '!HHI'
OFP_ACTION_ENCRYPT_SUZE = 8
assert calcsize(OFP_ACTION_ENCRYPT_PACK_STR) == OFP_ACTION_ENCRYPT_SIZE

OFP_ACTION_DECRYPT_PACK_STR = '!HHI'
OFP_ACTION_DECRYPT_SIZE = 8
assert calcsize(OFP_ACTOIN_DECRYPT_PACK_STR) == OFP_ACTION_DECRYPT_SIZE
